...
void Init(void) {
    ...
    /**********************************
     ...
     The parameter "face" selects the front, back, or both
     faces of polygons, and its/their drawing style
     according to the parameter "mode".
     The meaning of 'front' and 'back' is given by the
     order in which vertices are specified and the
     right-hand rule.
